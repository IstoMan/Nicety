...
int document_init_mupdf(Document *document, const char *file_path)
{
...
void init_page_texture_sdl(Page *page, Application *app)
{
...
// {
// 	return document_init_mupdf(file_path, document);
// }
